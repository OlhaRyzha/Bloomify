...
from shop.services.subscriptions import apply_subscription_payment_payload
        ...
        try:
            with transaction.atomic():
                ...
                payment = SubscriptionPayment.objects.create(
                    ...
                    amount=plan.price,
                    status="pending",
                    payment_status_token_hash=hash_order_access_token(
...
class LiqPaySubscriptionCallbackView(APIView):
    ...
    def post(self, request: Request) -> Response:
        ...
        apply_subscription_payment_payload(payment, payload)

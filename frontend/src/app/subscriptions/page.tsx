...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    // Page-level canonical; otherwise the root layout's canonical ("/")
    // is inherited and this page looks like a duplicate of home.
    alternates: {
      canonical: getAbsoluteLocalizedUrl('/subscriptions', locale),
      languages: getLanguageAlternates('/subscriptions'),
    },
  };
}
